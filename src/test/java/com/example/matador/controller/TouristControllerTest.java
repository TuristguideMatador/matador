...
class TouristControllerTest {
    ...
    void showTouristAttractionCreationForm() throws Exception {
        List<String> locations = List.of("Nørrebro", "Valby");
        ...
        mockMvc.perform(get("/attractions/add"))
                ...
                .andExpect(model().attribute("allLocations", locations));
    }
    ...
    void getTagsForTouristAttraction() throws Exception {
        ...
        tivoli.setAttractionId(1);
        tivoli.setLocationId(1);
        tivoli.setName("Tivoli");
        tivoli.setDescription("Forlystelsespark");
        tivoli.setTags(List.of("BØRNEVENLIG", "GRATIS"));
    ...
    void ShouldRegisterNewAttraction() throws Exception {
        ...
        ArgumentCaptor<TouristAttraction> captor =
                ArgumentCaptor.forClass(TouristAttraction.class);
        ...
        assertEquals(List.of("BØRNEVENLIG", "KULTUR"), captured.getTags());
    }
    @Test
    void ShouldRegisterNewAttractionButWrongAsserts() throws Exception {

        TouristAttraction touristAttraction = new TouristAttraction();
        touristAttraction.setName("Hvidovrevej");
        touristAttraction.setDescription("Et godt sted at starte");
        touristAttraction.setLocation("Nørrebro");
        touristAttraction.setTags(List.of("BØRNEVENLIG", "KULTUR"));

        when(service.addTouristAttraction(any(TouristAttraction.class)))
                .thenReturn(touristAttraction);
    ...
    void ShouldShowTouristAttractionToDelete() throws Exception {
        ...
        when(service.getTouristAttractionByName("Hvidovrevej"))
                .thenReturn(touristAttraction);
